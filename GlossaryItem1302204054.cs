...
{
    class GlossaryItem1302204054
    {
        public GlossaryClass glossary { get; set; }

        public void ReadJSON()
        {
            string fileName = "jurnal6_3_1302204054.json";

            string jsonString = File.ReadAllText(fileName);
            GlossaryItem1302204054 jsonData = JsonSerializer.Deserialize<GlossaryItem1302204054>(jsonString);
